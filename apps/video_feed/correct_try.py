    ...
    if landmarks is not None:
        ...
        if confidence > CONFIDENCE_THRESHOLD:
            ...
            if len(pose_tracker) == pose_tracker.maxlen:
                ...
                # Provide instructions if a new pose is detected
                if current_pose != last_detected_pose and current_pose in yoga_poses:
                    print(f"New pose detected: {current_pose}")
        ...
        ''''if results.pose_landmarks:
            ...
            cv2.putText(image, f"Right Elbow Angle: {angle:.2f}", (10, 90), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2)*/'''
